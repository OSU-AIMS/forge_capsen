...
def main():
  ...
  #   # rospy.loginfo(ft_sensor.wrench)    # pose_next =     p.press_incremental(.05)forging_client.get_current_pose()
  ...
  try:
    ...
    # # press part
    # try:
    #   p.press_incremental_with_force_fb(.002)
    # except ValueError as err:
    #   print(err.args)
    #   raise SystemExit
    # else:
    ...
    #     else:
    #       try:
    #         p.press_incremental_with_force_fb(.003)
    #       except ValueError as err:
    #         print(err.args)
    #         raise SystemExit
    #       else:
    ...
    #   else:
    #     try:
    #       p.press_incremental_with_force_fb(.00075)
    #     except ValueError as err:
    #       print(err.args)
    #       raise SystemExit
    #     else:
